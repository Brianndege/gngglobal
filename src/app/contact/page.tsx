...
export default function ContactPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.message.trim()) {
      ...
      nextErrors.message = "Please provide at least 20 characters so we can better assist you.";
    }
            ...
            <ScrollReveal direction="scale">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/about" className="inline-block px-10 py-4 bg-gold hover:bg-gold-600 text-navy-900 font-inter font-semibold rounded-md transition-all duration-300 hover:shadow-xl">
                    About Our Approach
                  </Link>
                  <Link href="/portfolio" className="inline-block px-10 py-4 border-2 border-white text-white hover:bg-white hover:text-navy-900 font-inter font-semibold rounded-md transition-all duration-300">
                    View Portfolio
                  </Link>
                </div>
              </div>

          ...
          <section id="team" className="py-16 md:py-24 bg-[#293d7c] text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
              ...
              <StaggeredGrid pattern="grid" className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  { name: "Scott Geare", image: "/team/scot.jpg" },
                  { name: "Newton Ndege", image: "/team/newton.jpg" },
                  { name: "Iain Geare", image: "/team/Ian.jpg" },
                  { name: "Daniel Ngetich", image: "/team/daniel.jpg" },
                ].map((member, idx) => (
                  <div key={member.name} className="text-center">
                    <div className="relative w-32 h-32 rounded-full mx-auto mb-4 overflow-hidden border border-white/40">
                      <Image
                        src={member.image}
                        alt={member.name}
                        fill
                        sizes="128px"
                        className="object-contain object-center bg-charcoal-900"
                      />
                    </div>
              ...
              <ScrollReveal direction="up" delay={0.5}>
                <div className="text-center mt-12">
                  <Link href="/team">
                    <Button
                      size="lg"
                      className="bg-navy-700 hover:bg-navy-800 text-white border border-navy-600 transition-all duration-300"
                    >
                      Meet the Full Team
                    </Button>
                  </Link>
